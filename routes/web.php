...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['role:manager'])->group(function () {
        ...
        // SAYA PINDAHKAN 'update-status' DARI SINI KE BAWAH
        // AGAR SUPPLIER BISA AKSES
    });
    ...
    // ====================================================
    // ZONA LIST RESTOCK & UPDATE STATUS (Manager & Supplier)
    // ====================================================
    // Group ini mengizinkan Manager DAN Supplier
    Route::middleware(['role:manager,supplier'])->group(function () {
        ...
        // Rute ini sekarang bisa diakses oleh Supplier!
